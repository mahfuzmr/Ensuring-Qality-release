...
#logging.basicConfig(filename="C:/logs/selenium/selenium_ui.log",format='%(asctime)s %(message)s',filemode='w') #/var/log/selenium/selenium_ui.log
logging.basicConfig(filename="/var/log/selenium/selenium_ui.log",format='%(asctime)s %(message)s',filemode='w') 
